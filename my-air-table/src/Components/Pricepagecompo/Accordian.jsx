      ...
      <Accordion width="60%" margin="auto" marginTop="40px" allowToggle>
        <AccordionItem>
          ...
          <AccordionPanel fontSize="20px" color="#666" textAlign="left" pb={4}>
            ...
            If you are on a paid Airtable plan, you will be charged for all
        ...
        <AccordionItem>
          ...
          <AccordionPanel fontSize="20px" color="#666" textAlign="left" pb={4}>
            pgrades to Airtable Enterprise apply per account within an
        ...
        <AccordionItem>
          ...
          <AccordionPanel fontSize="20px" color="#666" textAlign="left" pb={4}>
            ...
            started. For teams who like the features of our Free plan but need
            more storage, our Plus plan is available for $10/user. Our Pro plan
        ...
        <AccordionItem>
          ...
          <AccordionPanel fontSize="20px" color="#666" textAlign="left" pb={4}>
            While we don’t limit the number of bases you can create, we do limit
        ...
        <AccordionItem border="none">
          ...
          <AccordionPanel fontSize="20px" color="#666" textAlign="left" pb={4}>
            ...
            Jira count as premium sync integrations and are only available as
